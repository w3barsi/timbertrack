...
<div id="piechart">
<h2> <center> Sales</center></h2>
</div>


<div id="listofprod">
    <h2> <center> Product Sales</center></h2>
...
<div id="selectedprod">
    ...
    <table id="ListofProdTable" style="display:inline-block; float: right; width:68%;margin-top:3%; margin-right:3%">

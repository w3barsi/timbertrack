    ...
    <div id="header">
        <div class="hover" style=" width:17%; height:100%; float:right; border-left: 1px solid gray;">
            ...
            <div  class="hover2" style=" width:17%; height:100%; float:right; border-left: 1px solid gray;">
                <i class="fa fa-angle-down" style="margin-top:1.8%;margin-left:2%; position: absolute; font-size:35px; " onclick="HideShowRegister()"> </i>
                <p style="font-size:30px; margin-left:30%; margin-top:10%; cursor: pointer;" onclick="HideShowRegister()">  REGISTER  </p>
